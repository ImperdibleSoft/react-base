...
import { APP_NAME, APP_DESC, APP_COLOR } from '../src/common/constants/branding';
import { UniversalConfiguration } from 'universal-webpack';
...
export const universalSettings: UniversalConfiguration = {
  server: {
    input: path.resolve(paths.src, 'server/index.ts'),
    output: path.resolve(paths.dist, 'server.js'),
  },
};
